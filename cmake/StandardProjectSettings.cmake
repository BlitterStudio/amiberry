...
if (NOT CMAKE_SYSTEM_NAME MATCHES "Darwin")
    ...
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "-Wl,--as-needed -Wl,--gc-sections -Wl,--strip-all ${CMAKE_EXE_LINKER_FLAGS}")
    set(CMAKE_EXE_LINKER_FLAGS_DEBUG "-g ${CMAKE_EXE_LINKER_FLAGS}")
    set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "-Wl,--as-needed -Wl,--gc-sections -Wl,--strip-all ${CMAKE_EXE_LINKER_FLAGS}")
    set(CMAKE_SHARED_LINKER_FLAGS_DEBUG "-g ${CMAKE_EXE_LINKER_FLAGS}")
else ()
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "-Wl,-dead_strip ${CMAKE_EXE_LINKER_FLAGS}")
endif()
