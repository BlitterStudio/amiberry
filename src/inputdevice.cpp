...
STATIC_INLINE int getbuttonstate (int joy, int button)
{
	return (joybutton[joy] & (1 << button)) ? 1 : 0;
}

STATIC_INLINE int getvelocity (int num, int subnum, int pct)
{
	int val;
	int v;
...
extern int vpos;
STATIC_INLINE void readinput (void)
{
	uae_u32 totalvpos;
	int diff;
...
STATIC_INLINE uae_u16 getjoystate (int joy)
{
	uae_u16 v;
...
STATIC_INLINE bool cd32padmode (uae_u16 p5dir, uae_u16 p5dat)
{
...
STATIC_INLINE uae_u16 POTDAT (int joy)
{
...
STATIC_INLINE int check_input_queue (int evt)
{
...
STATIC_INLINE int getqualid (int evt)
{
...
STATIC_INLINE uae_u64 isqual (int evt)
{
