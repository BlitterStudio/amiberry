...
static NavigationMap navMap[] =
{
	...
	{"cboCPUFrequency", "chk24Bit", "CPU and FPU", "sldCpuIdle", "sldJitCacheSize"},
	{"sldJitCacheSize", "", "", "cboCPUFrequency", "chkFPUJIT"},
	...
	{ "chkCycleExact", "Chipset", "chkKeyboardConnected", "optFullECS", "chkMemoryCycleExact" },
	{ "chkMemoryCycleExact", "Chipset", "chkFastCopper", "chkCycleExact", "chkMultithreadedDrawing" },
	{ "optAGA", "optOCS", "chkKeyboardConnected", "optCollFull", "optECSDenise" },
	...
	{ "chkKeyboardConnected", "optAGA", "Chipset", "optCollNone", "chkSubpixelEmu" },
	{ "chkSubpixelEmu", "optAGA", "Chipset", "chkKeyboardConnected", "chkBlitImmed" },
	{ "chkBlitImmed", "optAGA", "Chipset", "chkSubpixelEmu", "chkBlitWait" },
	{ "chkBlitWait", "chkNTSC", "Chipset", "chkBlitImmed", "optCollNone" },
	...
	{ "chkShowGUI", "Miscellaneous", "cmdKeyOpenGUI", "chkMouseUntrap", "chkSyncClock" },
	{ "chkSyncClock", "Miscellaneous", "cmdKeyForQuit", "chkBSDSocket", "chkResetDelay" },
	{ "chkResetDelay", "Miscellaneous", "cmdKeyForQuit", "chkSyncClock", "chkFasterRTG" },
	{ "chkFasterRTG", "Miscellaneous", "cmdKeyActionReplay", "chkResetDelay", "chkClipboardSharing" },
	{ "chkClipboardSharing", "Miscellaneous", "cmdKeyActionReplay", "chkFasterRTG", "chkAllowNativeCode" },
	{ "chkAllowNativeCode", "Miscellaneous", "cmdKeyFullScreen", "chkClipboardSharing", "chkStatusLineNative" },
	{ "chkStatusLineNative", "Miscellaneous", "cmdKeyFullScreen", "chkAllowNativeCode", "chkStatusLineRtg" },
	{ "chkStatusLineRtg", "Miscellaneous", "cmdKeyMinimize", "chkStatusLineNative", "chkIllegalMem" },
	{ "chkIllegalMem", "Miscellaneous", "cboNumlock", "chkStatusLineRtg", "chkMinimizeInactive" },
	{ "chkMinimizeInactive", "Miscellaneous", "cboScrolllock", "chkIllegalMem", "chkMasterWP" },
	{ "chkMasterWP", "Miscellaneous", "cboCapsLock", "chkMinimizeInactive", "chkHDRO" },
	{ "chkHDRO", "Miscellaneous", "Miscellaneous", "chkMasterWP", "chkHideAutoconfig" },
	{ "chkHideAutoconfig", "Miscellaneous", "Miscellaneous", "chkHDRO", "chkRCtrlIsRAmiga" },
	{ "chkRCtrlIsRAmiga", "Miscellaneous", "Miscellaneous", "chkHideAutoconfig", "chkCaptureAlways" },
	{ "chkCaptureAlways", "Miscellaneous", "Miscellaneous", "chkRCtrlIsRAmiga", "chkScsiDisable" },
	{ "chkScsiDisable", "Miscellaneous", "Miscellaneous", "chkCaptureAlways", "chkAltTabRelease" },
	{ "chkAltTabRelease", "Miscellaneous", "Miscellaneous", "chkCaptureAlways", "chkRetroArchQuit" },
	{ "chkRetroArchQuit", "Miscellaneous", "Miscellaneous", "chkAltTabRelease", "chkRetroArchMenu" },
	{ "chkRetroArchMenu", "Miscellaneous", "Miscellaneous", "chkRetroArchQuit", "chkRetroArchReset" },
	{ "chkRetroArchReset", "Miscellaneous", "Miscellaneous", "chkRetroArchMenu", "cmdKeyOpenGUI" },

	{ "cmdKeyOpenGUI", "chkMouseUntrap", "cmdKeyOpenGUIClear", "cboCapsLock", "cmdKeyForQuit" },
	{ "cmdKeyOpenGUIClear", "cmdKeyOpenGUI", "Miscellaneous", "cboCapsLock", "cmdKeyForQuitClear" },
	{ "cmdKeyForQuit", "chkSyncClock", "cmdKeyForQuitClear", "cmdKeyOpenGUI", "cmdKeyActionReplay" },
	{ "cmdKeyForQuitClear", "cmdKeyForQuit", "Miscellaneous", "cmdKeyOpenGUIClear", "cmdKeyActionReplayClear" },
	{ "cmdKeyActionReplay", "chkFasterRTG", "cmdKeyActionReplayClear", "cmdKeyForQuit", "cmdKeyFullScreen" },
	{ "cmdKeyActionReplayClear", "cmdKeyActionReplay", "Miscellaneous", "cmdKeyForQuitClear", "cmdKeyFullScreenClear" },
	{ "cmdKeyFullScreen", "chkAllowNativeCode", "cmdKeyFullScreenClear", "cmdKeyActionReplay", "cmdKeyMinimize" },
	{ "cmdKeyFullScreenClear", "cmdKeyFullScreen", "Miscellaneous", "cmdKeyActionReplayClear", "cmdKeyMinimizeClear" },
	{ "cmdKeyMinimize", "chkStatusLineRtg", "cmdKeyMinimizeClear", "cmdKeyFullScreen", "cboNumlock" },
	{ "cmdKeyMinimizeClear", "cmdKeyMinimize", "Miscellaneous", "cmdKeyFullScreenClear", "cboNumlock" },
	{ "cboNumlock", "chkIllegalMem", "Miscellaneous", "cmdKeyMinimize", "cboScrolllock" },
	{ "cboScrolllock", "chkMinimizeInactive", "Miscellaneous", "cboNumlock", "cboCapsLock" },
	{ "cboCapsLock", "chkMasterWP", "Miscellaneous", "cboScrolllock", "cmdKeyOpenGUI"},
