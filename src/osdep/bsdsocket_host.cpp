...
static uae_sem_t sem_queue = nullptr;
...
static int mapErrno(int e)
{
	...
	case EAGAIN: e = 35;
		break;
	case EINPROGRESS: e = 36;
		break;
	case EALREADY: e = 37;
		break;
	case ENOTSOCK: e = 38;
		break;
	case EDESTADDRREQ: e = 39;
		break;
	case EMSGSIZE: e = 40;
		break;
	case EPROTOTYPE: e = 41;
		break;
	case ENOPROTOOPT: e = 42;
		break;
	case EPROTONOSUPPORT: e = 43;
		break;
	case ESOCKTNOSUPPORT: e = 44;
		break;
	case EOPNOTSUPP: e = 45;
		break;
	case EPFNOSUPPORT: e = 46;
		break;
	case EAFNOSUPPORT: e = 47;
		break;
	case EADDRINUSE: e = 48;
		break;
	case EADDRNOTAVAIL: e = 49;
		break;
	case ENETDOWN: e = 50;
		break;
	case ENETUNREACH: e = 51;
		break;
	case ENETRESET: e = 52;
		break;
	case ECONNABORTED: e = 53;
		break;
	case ECONNRESET: e = 54;
		break;
	case ENOBUFS: e = 55;
		break;
	case EISCONN: e = 56;
	...
	case ESHUTDOWN: e = 58;
		break;
	case ETOOMANYREFS: e = 59;
		break;
	case ETIMEDOUT: e = 60;
		break;
	case ECONNREFUSED: e = 61;
		break;
	case ELOOP: e = 62;
		break;
	case ENAMETOOLONG: e = 63;
		break;
	default: break;
	}
	return e;
...
static void copyHostent(const struct hostent* hostent, SB)
{
	...
	for (i = 0; i < numaddr; i++)
	{
		trap_put_long(sb->context, sb->hostent + 24 + (numaliases + i) * 4,
		              addmem(sb->context, &aptr, hostent->h_addr_list[i], hostent->h_length));
	}
...
static int bsdlib_threadfunc(void* arg)
{
	...
	while (true)
	{
		...
		case 7:
			{
				struct hostent* tmphostent = gethostbyaddr(reinterpret_cast<const char*>(get_real_address(sb->name)),
				                                           sb->a_addrlen, sb->flags);
...
void host_sendto(TrapContext* ctx, SB, uae_u32 sd, uae_u32 msg, uae_u8* hmsg, uae_u32 len, uae_u32 flags, uae_u32 to,
                 uae_u32 tolen)
{
	sb->s = getsock(ctx, sb, sd + 1);
	if (sb->s == -1)
...
void host_recvfrom(TrapContext* ctx, SB, uae_u32 sd, uae_u32 msg, uae_u8* hmsg, uae_u32 len, uae_u32 flags,
                   uae_u32 addr, uae_u32 addrlen)
{
...
void host_getservbynameport(TrapContext* ctx, SB, uae_u32 name, uae_u32 proto, uae_u32 type)
{
	...
	trap_put_long(ctx, sb->servent + 8, static_cast<unsigned short>(htons(s->s_port)));
                        ...
                        uae_u32 optval, uae_u32 optlen)
{
	...
	r = getsockopt(s, nativelevel, nativeoptname,
	               optval ? buf : nullptr, optlen ? &len : nullptr);
