...
{
    const et4000_t *et4000 = (et4000_t *) svga->p;
...
//    int         i;
    ...
    switch (dev->type) {
        ...
        case ET4000_TYPE_ISA: /* ISA ET4000AX */
            ...
            mem_mapping_addx(&dev->linear_mapping, 0, dev->vram_size, svga_read_linear, svga_readw_linear, svga_readl_linear, svga_write_linear, svga_writew_linear, svga_writel_linear, NULL, MEM_MAPPING_EXTERNAL, &dev->svga);
            mem_mapping_enablex(&dev->linear_mapping);
            break;
...
et4000_close(void *priv)
{
    ...
    sc1502x_ramdac_close(dev->svga.ramdac);
