...
{
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	MakeSR (regs);
{	uae_s16 src = get_iword (2);
	regs.sr |= src;
	MakeFromSR (regs);
...
{	uaecptr dsta = m68k_areg (regs, dstreg);
	...
	if ((extra & 0x800) && GET_CFLG ()) { Exception (6, regs); return 32 * CYCLE_UNIT / 2; }
}
}}}	m68k_incpc (4);
...
{	uae_u16 dmask = mask & 0xff, amask = (mask >> 8) & 0xff;
	while (dmask) { put_word (srca, m68k_dreg (regs, movem_index1[dmask])); srca += 2; dmask = movem_next[dmask]; writecycles += 3; }
	while (amask) { put_word (srca, m68k_areg (regs, movem_index1[amask])); srca += 2; amask = movem_next[amask]; writecycles += 3; }
}}}	m68k_incpc (4);
...
{	uae_u16 amask = mask & 0xff, dmask = (mask >> 8) & 0xff;
	...
	while (dmask) { srca -= 2; put_word (srca, m68k_dreg (regs, movem_index2[dmask])); dmask = movem_next[dmask]; writecycles += 3; }
	m68k_areg (regs, dstreg) = srca;
}}}	m68k_incpc (4);
return (writecycles + 9) * CYCLE_UNIT / 2;
}
...
return (writecycles + 18) * CYCLE_UNIT / 2;
}
...
return (writecycles + 11) * CYCLE_UNIT / 2;
}
...
{	uaecptr srca = m68k_areg (regs, dstreg);
{	uae_u16 dmask = mask & 0xff, amask = (mask >> 8) & 0xff;
	while (dmask) { put_long (srca, m68k_dreg (regs, movem_index1[dmask])); srca += 4; dmask = movem_next[dmask]; writecycles += 3; }
	while (amask) { put_long (srca, m68k_areg (regs, movem_index1[amask])); srca += 4; amask = movem_next[amask]; writecycles += 3; }
}}}	m68k_incpc (4);
return (writecycles + 8) * CYCLE_UNIT / 2;
}
...
{	uae_u16 amask = mask & 0xff, dmask = (mask >> 8) & 0xff;
	...
	while (dmask) { srca -= 4; put_long (srca, m68k_dreg (regs, movem_index2[dmask])); dmask = movem_next[dmask]; writecycles += 3; }
	m68k_areg (regs, dstreg) = srca;
}}}	m68k_incpc (4);
return (writecycles + 10) * CYCLE_UNIT / 2;
}
...
{	uae_u16 dmask = mask & 0xff, amask = (mask >> 8) & 0xff;
	while (dmask) { put_long (srca, m68k_dreg (regs, movem_index1[dmask])); srca += 4; dmask = movem_next[dmask]; writecycles += 3; }
	while (amask) { put_long (srca, m68k_areg (regs, movem_index1[amask])); srca += 4; amask = movem_next[amask]; writecycles += 3; }
}}}}return (writecycles + 13) * CYCLE_UNIT / 2;
}
...
return (readcycles + 14) * CYCLE_UNIT / 2;
}
...
return (readcycles + 22) * CYCLE_UNIT / 2;
}
...
{	while (dmask) { m68k_dreg (regs, movem_index1[dmask]) = (uae_s32)(uae_s16)get_word (srca); srca += 2; dmask = movem_next[dmask]; readcycles += 4; }
	while (amask) { m68k_areg (regs, movem_index1[amask]) = (uae_s32)(uae_s16)get_word (srca); srca += 2; amask = movem_next[amask]; readcycles += 4; }
}}}}return (readcycles + 17) * CYCLE_UNIT / 2;
}
...
return (readcycles + 15) * CYCLE_UNIT / 2;
}
...
{	uae_u16 mask = get_iword (2);
	unsigned int dmask = mask & 0xff, amask = (mask >> 8) & 0xff;
{	uaecptr srca = m68k_areg (regs, dstreg);
{	while (dmask) { m68k_dreg (regs, movem_index1[dmask]) = get_long (srca); srca += 4; dmask = movem_next[dmask]; readcycles += 4; }
	while (amask) { m68k_areg (regs, movem_index1[amask]) = get_long (srca); srca += 4; amask = movem_next[amask]; readcycles += 4; }
}}}	m68k_incpc (4);
return (readcycles + 14) * CYCLE_UNIT / 2;
}
...
return (readcycles + 24) * CYCLE_UNIT / 2;
}
...
{	while (dmask) { m68k_dreg (regs, movem_index1[dmask]) = get_long (srca); srca += 4; dmask = movem_next[dmask]; readcycles += 4; }
	while (amask) { m68k_areg (regs, movem_index1[amask]) = get_long (srca); srca += 4; amask = movem_next[amask]; readcycles += 4; }
}}}}return (readcycles + 19) * CYCLE_UNIT / 2;
}
...
{	uae_u16 newsr; uae_u32 newpc;
	for (;;) {
		...
		uae_s16 sr = get_word (a);
		uae_s32 pc = get_long (a + 2);
		uae_s16 format = get_word (a + 2 + 4);
		int frame = format >> 12;
		int offset = 8;
		newsr = sr; newpc = pc;
		...
		else { m68k_areg (regs, 7) += offset; Exception (14, regs); return 24 * CYCLE_UNIT / 2; }
...
{	int regno = (src >> 12) & 15;
	...
	cyc = m68k_movec2(src & 0xFFF, regp);
	if (cyc ) goto endlabel911;
	cyc = 7;
}}}}	m68k_incpc (4);
endlabel911:
...
{	int regno = (src >> 12) & 15;
	uae_u32 *regp = regs.regs + regno;
  cyc = m68k_move2c(src & 0xFFF, regp);
	if (cyc) goto endlabel912;
	cyc = 13;
}}}}	m68k_incpc (4);
endlabel912:
return cyc * CYCLE_UNIT / 2;
...
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 0)) { Exception (7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 1)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 2)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 3)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 4)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 5)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 6)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 7)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 8)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 9)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 10)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 11)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 12)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 13)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 14)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
{
{{	uae_s16 dummy = get_iword (2);
	if (cctrue (regs.ccrflags, 15)) { Exception(7, regs); return 33 * CYCLE_UNIT / 2; }
}}	m68k_incpc (4);
return 10 * CYCLE_UNIT / 2;
}
...
/* ROXL.W Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e170_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 9) & 7);
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 cnt = m68k_dreg (regs, srcreg);
...
/* ROL.W Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e178_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 9) & 7);
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 cnt = m68k_dreg (regs, srcreg);
...
/* ASLQ.L #<data>,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e180_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = imm8_table[((opcode >> 9) & 7)];
	uae_u32 dstreg = opcode & 7;
{{	uae_u32 cnt = srcreg;
...
/* LSLQ.L #<data>,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e188_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = imm8_table[((opcode >> 9) & 7)];
	uae_u32 dstreg = opcode & 7;
{{	uae_u32 cnt = srcreg;
...
/* ROXLQ.L #<data>,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e190_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = imm8_table[((opcode >> 9) & 7)];
	uae_u32 dstreg = opcode & 7;
{{	uae_u32 cnt = srcreg;
...
/* ROLQ.L #<data>,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e198_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = imm8_table[((opcode >> 9) & 7)];
	uae_u32 dstreg = opcode & 7;
{{	uae_u32 cnt = srcreg;
...
/* ASL.L Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e1a0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 9) & 7);
	uae_u32 dstreg = opcode & 7;
{{	uae_s32 cnt = m68k_dreg (regs, srcreg);
...
/* LSL.L Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e1a8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 9) & 7);
	uae_u32 dstreg = opcode & 7;
{{	uae_s32 cnt = m68k_dreg (regs, srcreg);
...
/* ROXL.L Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e1b0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 9) & 7);
	uae_u32 dstreg = opcode & 7;
{{	uae_s32 cnt = m68k_dreg (regs, srcreg);
...
/* ROL.L Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e1b8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 9) & 7);
	uae_u32 dstreg = opcode & 7;
{{	uae_s32 cnt = m68k_dreg (regs, srcreg);
...
/* ASLW.W (An) */
unsigned long REGPARAM2 CPUFUNC(op_e1d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ASLW.W (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_e1d8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ASLW.W -(An) */
unsigned long REGPARAM2 CPUFUNC(op_e1e0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	dataa = m68k_areg (regs, srcreg) - 2;
...
/* ASLW.W (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_e1e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
...
/* ASLW.W (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_e1f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	m68k_incpc (2);
...
/* ASLW.W (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_e1f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
{	uae_u32 val = (uae_u16)data;
...
/* ASLW.W (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_e1f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = get_ilong (2);
{	uae_s16 data = get_word (dataa);
{	uae_u32 val = (uae_u16)data;
...
/* LSRW.W (An) */
unsigned long REGPARAM2 CPUFUNC(op_e2d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* LSRW.W (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_e2d8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* LSRW.W -(An) */
unsigned long REGPARAM2 CPUFUNC(op_e2e0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	dataa = m68k_areg (regs, srcreg) - 2;
...
/* LSRW.W (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_e2e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
...
/* LSRW.W (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_e2f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	m68k_incpc (2);
...
/* LSRW.W (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_e2f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
{	uae_u32 val = (uae_u16)data;
...
/* LSRW.W (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_e2f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = get_ilong (2);
{	uae_s16 data = get_word (dataa);
{	uae_u32 val = (uae_u16)data;
...
/* LSLW.W (An) */
unsigned long REGPARAM2 CPUFUNC(op_e3d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* LSLW.W (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_e3d8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* LSLW.W -(An) */
unsigned long REGPARAM2 CPUFUNC(op_e3e0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	dataa = m68k_areg (regs, srcreg) - 2;
...
/* LSLW.W (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_e3e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
...
/* LSLW.W (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_e3f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	m68k_incpc (2);
...
/* LSLW.W (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_e3f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* LSLW.W (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_e3f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = get_ilong (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* ROXRW.W (An) */
unsigned long REGPARAM2 CPUFUNC(op_e4d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ROXRW.W (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_e4d8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ROXRW.W -(An) */
unsigned long REGPARAM2 CPUFUNC(op_e4e0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	dataa = m68k_areg (regs, srcreg) - 2;
...
/* ROXRW.W (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_e4e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
...
/* ROXRW.W (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_e4f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	m68k_incpc (2);
...
/* ROXRW.W (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_e4f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* ROXRW.W (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_e4f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = get_ilong (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* ROXLW.W (An) */
unsigned long REGPARAM2 CPUFUNC(op_e5d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ROXLW.W (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_e5d8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ROXLW.W -(An) */
unsigned long REGPARAM2 CPUFUNC(op_e5e0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	dataa = m68k_areg (regs, srcreg) - 2;
...
/* ROXLW.W (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_e5e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
...
/* ROXLW.W (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_e5f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	m68k_incpc (2);
...
/* ROXLW.W (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_e5f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* ROXLW.W (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_e5f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = get_ilong (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* RORW.W (An) */
unsigned long REGPARAM2 CPUFUNC(op_e6d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* RORW.W (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_e6d8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* RORW.W -(An) */
unsigned long REGPARAM2 CPUFUNC(op_e6e0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	dataa = m68k_areg (regs, srcreg) - 2;
...
/* RORW.W (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_e6e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
...
/* RORW.W (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_e6f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	m68k_incpc (2);
...
/* RORW.W (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_e6f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* RORW.W (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_e6f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = get_ilong (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* ROLW.W (An) */
unsigned long REGPARAM2 CPUFUNC(op_e7d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ROLW.W (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_e7d8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg);
{	uae_s16 data = get_word (dataa);
...
/* ROLW.W -(An) */
unsigned long REGPARAM2 CPUFUNC(op_e7e0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	dataa = m68k_areg (regs, srcreg) - 2;
...
/* ROLW.W (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_e7e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
...
/* ROLW.W (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_e7f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr dataa;
	m68k_incpc (2);
...
/* ROLW.W (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_e7f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = (uae_s32)(uae_s16)get_iword (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* ROLW.W (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_e7f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr dataa = get_ilong (2);
{	uae_s16 data = get_word (dataa);
{	uae_u16 val = data;
...
/* BFTST.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e8c0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFTST.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_e8d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_e8e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_e8f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_e8f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_e8f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_e8fa_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 2;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_getpc (regs) + 4;
...
unsigned long REGPARAM2 CPUFUNC(op_e8fb_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 3;
{{	uae_s16 extra = get_iword (2);
{	uaecptr tmppc;
...
/* BFEXTU.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_e9c0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFEXTU.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_e9d0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_e9e8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_e9f0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_e9f8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_e9f9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_e9fa_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 2;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_getpc (regs) + 4;
...
unsigned long REGPARAM2 CPUFUNC(op_e9fb_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 3;
{{	uae_s16 extra = get_iword (2);
{	uaecptr tmppc;
...
/* BFCHG.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_eac0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFCHG.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_ead0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_eae8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_eaf0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_eaf8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_eaf9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
/* BFEXTS.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_ebc0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFEXTS.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_ebd0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_ebe8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_ebf0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_ebf8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_ebf9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_ebfa_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 2;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_getpc (regs) + 4;
...
unsigned long REGPARAM2 CPUFUNC(op_ebfb_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 3;
{{	uae_s16 extra = get_iword (2);
{	uaecptr tmppc;
...
/* BFCLR.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_ecc0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFCLR.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_ecd0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_ece8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_ecf0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_ecf8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_ecf9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
/* BFFFO.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_edc0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFFFO.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_edd0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_ede8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_edf0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_edf8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_edf9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_edfa_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 2;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_getpc (regs) + 4;
...
unsigned long REGPARAM2 CPUFUNC(op_edfb_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 3;
{{	uae_s16 extra = get_iword (2);
{	uaecptr tmppc;
...
/* BFSET.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_eec0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFSET.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_eed0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_eee8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_eef0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_eef8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_eef9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
/* BFINS.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_efc0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{{	uae_u32 bdata[2];
...
/* BFINS.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_efd0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg);
...
unsigned long REGPARAM2 CPUFUNC(op_efe8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = m68k_areg (regs, dstreg) + (uae_s32)(uae_s16)get_iword (4);
...
unsigned long REGPARAM2 CPUFUNC(op_eff0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta;
...
unsigned long REGPARAM2 CPUFUNC(op_eff8_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = (uae_s32)(uae_s16)get_iword (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_eff9_0)(uae_u32 opcode, struct regstruct &regs)
{
{{	uae_s16 extra = get_iword (2);
{	uaecptr dsta = get_ilong (4);
{	uae_u32 bdata[2];
...
unsigned long REGPARAM2 CPUFUNC(op_f010_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	uaecptr pc = m68k_getpc (regs);
...
unsigned long REGPARAM2 CPUFUNC(op_f028_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	uaecptr pc = m68k_getpc (regs);
	uae_u16 extra = x_get_word (pc + 2);
	m68k_incpc (4);
{	uaecptr extraa = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (0);
	m68k_incpc (2);
	mmu_op30 (pc, opcode, regs, extra, extraa);
}}}return 8 * CYCLE_UNIT / 2;
}
...
unsigned long REGPARAM2 CPUFUNC(op_f030_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	uaecptr pc = m68k_getpc (regs);
	...
	m68k_incpc (4);
{	uaecptr extraa;
{	extraa = get_disp_ea_020 (regs, m68k_areg (regs, srcreg), next_iword (regs));
	mmu_op30 (pc, opcode, regs, extra, extraa);
}}}}return 10 * CYCLE_UNIT / 2;
}

/* MMUOP030.L (xxx).W,#<data>.W */
unsigned long REGPARAM2 CPUFUNC(op_f038_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	uaecptr pc = m68k_getpc (regs);
	uae_u16 extra = x_get_word (pc + 2);
	m68k_incpc (4);
{	uaecptr extraa = (uae_s32)(uae_s16)get_iword (0);
	m68k_incpc (2);
	mmu_op30 (pc, opcode, regs, extra, extraa);
}}}return 8 * CYCLE_UNIT / 2;
}
...
unsigned long REGPARAM2 CPUFUNC(op_f039_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	uaecptr pc = m68k_getpc (regs);
	uae_u16 extra = x_get_word (pc + 2);
	m68k_incpc (4);
{	uaecptr extraa = get_ilong (0);
	m68k_incpc (4);
	mmu_op30 (pc, opcode, regs, extra, extraa);
}}}return 12 * CYCLE_UNIT / 2;
}
...
/* FPP.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_f200_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FPP.L #<data>.W,An */
unsigned long REGPARAM2 CPUFUNC(op_f208_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FPP.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_f210_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FPP.L #<data>.W,(An)+ */
unsigned long REGPARAM2 CPUFUNC(op_f218_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FPP.L #<data>.W,-(An) */
unsigned long REGPARAM2 CPUFUNC(op_f220_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FPP.L #<data>.W,(d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_f228_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
unsigned long REGPARAM2 CPUFUNC(op_f230_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FPP.L #<data>.W,(xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_f238_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
{	uae_s16 extra = get_iword (2);
...
/* FPP.L #<data>.W,(xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_f239_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
{	uae_s16 extra = get_iword (2);
...
/* FPP.L #<data>.W,(d16,PC) */
unsigned long REGPARAM2 CPUFUNC(op_f23a_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 2;
{
#ifdef FPUEMU
...
unsigned long REGPARAM2 CPUFUNC(op_f23b_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = 3;
{
#ifdef FPUEMU
...
/* FPP.L #<data>.W,#<data>.L */
unsigned long REGPARAM2 CPUFUNC(op_f23c_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
{	uae_s16 extra = get_iword (2);
...
/* FScc.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_f240_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FDBcc.L #<data>.W,Dn */
unsigned long REGPARAM2 CPUFUNC(op_f248_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FScc.L #<data>.W,(An) */
unsigned long REGPARAM2 CPUFUNC(op_f250_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FScc.L #<data>.W,(An)+ */
unsigned long REGPARAM2 CPUFUNC(op_f258_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FScc.L #<data>.W,-(An) */
unsigned long REGPARAM2 CPUFUNC(op_f260_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
unsigned long REGPARAM2 CPUFUNC(op_f268_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
unsigned long REGPARAM2 CPUFUNC(op_f270_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{
#ifdef FPUEMU
...
/* FScc.L #<data>.W,(xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_f278_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
{	uae_s16 extra = get_iword (2);
...
/* FScc.L #<data>.W,(xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_f279_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
{	uae_s16 extra = get_iword (2);
...
/* FTRAPcc.L #<data>.W */
unsigned long REGPARAM2 CPUFUNC(op_f27a_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
	uaecptr oldpc = m68k_getpc (regs);
...
/* FTRAPcc.L #<data>.L */
unsigned long REGPARAM2 CPUFUNC(op_f27b_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
	uaecptr oldpc = m68k_getpc (regs);
	uae_u16 extra = get_iword (2);
{	uae_s32 dummy = get_ilong (4);
	m68k_incpc (8);
	fpuop_trapcc (opcode, regs, oldpc, extra);
}
#endif
...
/* FTRAPcc.L  */
unsigned long REGPARAM2 CPUFUNC(op_f27c_0)(uae_u32 opcode, struct regstruct &regs)
{
{
#ifdef FPUEMU
	uaecptr oldpc = m68k_getpc (regs);
...
/* FBccQ.L #<data>,#<data>.W */
unsigned long REGPARAM2 CPUFUNC(op_f280_0)(uae_u32 opcode, struct regstruct &regs)
{
...
/* FBccQ.L #<data>,#<data>.L */
unsigned long REGPARAM2 CPUFUNC(op_f2c0_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 63);
{
#ifdef FPUEMU
...
/* FSAVE.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f310_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FSAVE.L -(An) */
unsigned long REGPARAM2 CPUFUNC(op_f320_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FSAVE.L (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_f328_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FSAVE.L (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_f330_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FSAVE.L (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_f338_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
#ifdef FPUEMU
...
/* FSAVE.L (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_f339_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
#ifdef FPUEMU
...
/* FRESTORE.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f350_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FRESTORE.L (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_f358_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FRESTORE.L (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_f368_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FRESTORE.L (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_f370_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
...
/* FRESTORE.L (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_f378_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
#ifdef FPUEMU
...
/* FRESTORE.L (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_f379_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
#ifdef FPUEMU
...
/* FRESTORE.L (d16,PC) */
unsigned long REGPARAM2 CPUFUNC(op_f37a_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
#ifdef FPUEMU
...
/* FRESTORE.L (d8,PC,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_f37b_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{
#ifdef FPUEMU
...
/* CINVLQ.L #<data>,An */
unsigned long REGPARAM2 CPUFUNC(op_f408_0)(uae_u32 opcode, struct regstruct &regs)
{
...
/* CINVPQ.L #<data>,An */
unsigned long REGPARAM2 CPUFUNC(op_f410_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
	uae_u32 dstreg = opcode & 7;
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f418_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f419_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f41a_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f41b_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f41c_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f41d_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f41e_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CINVAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f41f_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHLQ.L #<data>,An */
unsigned long REGPARAM2 CPUFUNC(op_f428_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
	uae_u32 dstreg = opcode & 7;
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
...
/* CPUSHPQ.L #<data>,An */
unsigned long REGPARAM2 CPUFUNC(op_f430_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
	uae_u32 dstreg = opcode & 7;
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f438_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f439_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f43a_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f43b_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f43c_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f43d_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f43e_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* CPUSHAQ.L #<data> */
unsigned long REGPARAM2 CPUFUNC(op_f43f_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = ((opcode >> 6) & 3);
{if (!regs.s) { Exception(8, regs); return 27 * CYCLE_UNIT / 2; }
{	if (opcode & 0x80)
...
/* PFLUSHN.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f500_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* PFLUSH.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f508_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* PFLUSHAN.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f510_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* PFLUSHA.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f518_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* PTESTR.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f548_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* PTESTW.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f568_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* PLPAR.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f588_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* PLPAW.L (An) */
unsigned long REGPARAM2 CPUFUNC(op_f5c8_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	m68k_incpc (2);
...
/* MOVE16.L (An)+,(xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_f600_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{	uae_u32 v1, v2, v3, v4;
...
{	uaecptr memda = get_ilong (2);
	...
	v2 = get_long (memsa + 4);
	v3 = get_long (memsa + 8);
	v4 = get_long (memsa + 12);
	put_long (memda , v1);
	put_long (memda + 4, v2);
	put_long (memda + 8, v3);
	put_long (memda + 12, v4);
...
/* MOVE16.L (xxx).L,(An)+ */
unsigned long REGPARAM2 CPUFUNC(op_f608_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{	uae_u32 v1, v2, v3, v4;
...
/* MOVE16.L (An),(xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_f610_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{	uae_u32 v1, v2, v3, v4;
{	uaecptr memsa = m68k_areg (regs, srcreg);
...
/* MOVE16.L (xxx).L,(An) */
unsigned long REGPARAM2 CPUFUNC(op_f618_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 dstreg = opcode & 7;
{	uae_u32 v1, v2, v3, v4;
{	uaecptr memsa = get_ilong (2);
...
/* MOVE16.L (An)+,(An)+ */
unsigned long REGPARAM2 CPUFUNC(op_f620_0)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
	uae_u32 dstreg = 0;
{	uae_u32 v1, v2, v3, v4;
...
/* LPSTOP.L #<data>.W */
unsigned long REGPARAM2 CPUFUNC(op_f800_0)(uae_u32 opcode, struct regstruct &regs)
{
{if (!regs.s) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
{	uae_u16 sw = get_iword (2);
	uae_u16 sr;
	if (sw != (0x100|0x80|0x40)) { Exception (4, regs); return 32 * CYCLE_UNIT / 2; }
	sr = get_iword (4);
	if (!(sr & 0x8000)) { Exception (8, regs); return 27 * CYCLE_UNIT / 2; }
	regs.sr = sr;
	MakeFromSR (regs);
	m68k_setstopped();
	m68k_incpc (6);
...
#ifdef PART_4
/* NBCD.B Dn */
unsigned long REGPARAM2 CPUFUNC(op_4800_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uae_s8 src = m68k_dreg (regs, srcreg);
{	uae_u16 newv_lo = - (src & 0xF) - (GET_XFLG () ? 1 : 0);
...
/* NBCD.B (An) */
unsigned long REGPARAM2 CPUFUNC(op_4810_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr srca = m68k_areg (regs, srcreg);
{	uae_s8 src = get_byte (srca);
...
/* NBCD.B (An)+ */
unsigned long REGPARAM2 CPUFUNC(op_4818_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr srca = m68k_areg (regs, srcreg);
{	uae_s8 src = get_byte (srca);
...
/* NBCD.B -(An) */
unsigned long REGPARAM2 CPUFUNC(op_4820_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr srca;
	srca = m68k_areg (regs, srcreg) - areg_byteinc[srcreg];
...
/* NBCD.B (d16,An) */
unsigned long REGPARAM2 CPUFUNC(op_4828_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr srca = m68k_areg (regs, srcreg) + (uae_s32)(uae_s16)get_iword (2);
{	uae_s8 src = get_byte (srca);
...
/* NBCD.B (d8,An,Xn) */
unsigned long REGPARAM2 CPUFUNC(op_4830_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
{{	uaecptr srca;
	m68k_incpc (2);
...
/* NBCD.B (xxx).W */
unsigned long REGPARAM2 CPUFUNC(op_4838_2)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr srca = (uae_s32)(uae_s16)get_iword (2);
{	uae_s8 src = get_byte (srca);
{	uae_u16 newv_lo = - (src & 0xF) - (GET_XFLG () ? 1 : 0);
...
/* NBCD.B (xxx).L */
unsigned long REGPARAM2 CPUFUNC(op_4839_2)(uae_u32 opcode, struct regstruct &regs)
{
{{	uaecptr srca = get_ilong (2);
{	uae_s8 src = get_byte (srca);
{	uae_u16 newv_lo = - (src & 0xF) - (GET_XFLG () ? 1 : 0);
...
#ifdef PART_6
/* SBCD.B Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_8100_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
	uae_u32 dstreg = (opcode >> 9) & 7;
{{	uae_s8 src = m68k_dreg (regs, srcreg);
...
/* SBCD.B -(An),-(An) */
unsigned long REGPARAM2 CPUFUNC(op_8108_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
	uae_u32 dstreg = (opcode >> 9) & 7;
{{	uaecptr srca;
...
#ifdef PART_7
/* ABCD.B Dn,Dn */
unsigned long REGPARAM2 CPUFUNC(op_c100_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
	uae_u32 dstreg = (opcode >> 9) & 7;
{{	uae_s8 src = m68k_dreg (regs, srcreg);
...
/* ABCD.B -(An),-(An) */
unsigned long REGPARAM2 CPUFUNC(op_c108_2)(uae_u32 opcode, struct regstruct &regs)
{
	uae_u32 srcreg = (opcode & 7);
	uae_u32 dstreg = (opcode >> 9) & 7;
{{	uaecptr srca;
