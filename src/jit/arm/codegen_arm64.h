 ...
 * Use SXTW to reproduce 32-bit wrap semantics with NATMEM_OFFSET=0x80000000:
 * host = NATMEM_OFFSET + (uae_s32)addr == NATMEM_OFFSET + (uae_u32)addr mod 2^32. */
#define LDR_wXx(Wt,Xn,Xm)         _W((0b10111000011 << 21) | ((Xn) << 16) | (EX_SXTW << 13) | (0 << 12) | (0b10 << 10) | ((Xm) << 5) | (Wt))
...
#define LDRB_wXx(Wt,Xn,Xm)        _W((0b00111000011 << 21) | ((Xn) << 16) | (EX_SXTW << 13) | (0 << 12) | (0b10 << 10) | ((Xm) << 5) | (Wt))
#define LDRH_wXi(Wt,Xn,i)         _W((0b0111100101 << 22) | ((((i)/2) &0xfff) << 10) | ((Xn) << 5) | (Wt))
#define LDRH_wXx(Wt,Xn,Xm)        _W((0b01111000011 << 21) | ((Xn) << 16) | (EX_SXTW << 13) | (0 << 12) | (0b10 << 10) | ((Xm) << 5) | (Wt))
...
#define STR_wXx(Wt,Xn,Xm)         _W((0b10111000001 << 21) | ((Xn) << 16) | (EX_SXTW << 13) | (0 << 12) | (0b10 << 10) | ((Xm) << 5) | (Wt))
...
#define STRB_wXx(Wt,Xn,Xm)        _W((0b00111000001 << 21) | ((Xn) << 16) | (EX_SXTW << 13) | (0 << 12) | (0b10 << 10) | ((Xm) << 5) | (Wt))
#define STRH_wXi(Wt,Xn,i)         _W((0b0111100100 << 22) | ((((i)/2) &0xfff) << 10) | ((Xn) << 5) | (Wt))
#define STRH_wXx(Wt,Xn,Xm)        _W((0b01111000001 << 21) | ((Xn) << 16) | (EX_SXTW << 13) | (0 << 12) | (0b10 << 10) | ((Xm) << 5) | (Wt))
