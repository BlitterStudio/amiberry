...
int sys_command_cd_pause(int unitnum, int paused)
{
	...
	if (state[unitnum].device_func->pause == NULL) {
		...
		uae_u8 pausedValue = paused ? 0 : 1;
		uae_u8 cmd[10] = { 0x4b, 0, 0, 0, 0, 0, 0, 0, pausedValue, 0 };
...
int sys_command_cd_read(int unitnum, uae_u8 *data, int block, int size)
{
	...
	{
		uae_u8 block24 = block >> 24;
		uae_u8 block16 = block >> 16;
		uae_u8 block8 = block >> 8;
		uae_u8 block0 = block >> 0;
		uae_u8 size8 = size >> 8;
		uae_u8 size0 = size >> 0;
		uae_u8 cmd1[12] = { 0x28, 0, block24, block16, block8, block0, 0, size8, size0, 0, 0, 0 };
...
int sys_command_cd_rawread(int unitnum, uae_u8 *data, int block, int size, int sectorsize)
{
	...
	if (state[unitnum].device_func->rawread == NULL) 
	{
		...
		uae_u8 block8 = block >> 8;
		uae_u8 block0 = block >> 0;
		uae_u8 size16 = size >> 16;
		uae_u8 size8 = size >> 8;
		uae_u8 size0 = size >> 0;
		uae_u8 cmd[12] = { 0xbe, 0, block24, block16, block8, block0, size16, size8, size0, 0x10, 0, 0 };
...
int sys_command_read(int unitnum, uae_u8 *data, int block, int size)
{
	...
	if (state[unitnum].device_func->read == NULL) 
	{
		uae_u8 size24 = size >> 24;
		uae_u8 size16 = size >> 16;
		uae_u8 size8 = size >> 8;
		uae_u8 size0 = size >> 0;
		uae_u8 cmd[12] = { 0xa8, 0, 0, 0, 0, 0, size24, size16, size8, size0, 0, 0 };
