...
The same board also exposes the [ZZ9000Net.device Ethernet interface](zz9000-net.md)
and [ZZ9000AX AHI audio interface](zz9000-audio.md). A bounded [SDK mailbox
subset](zz9000-sdk.md) supports the installed `mhizz9000.library` audio-stream
protocol when Amiberry is built with mpg123. USB, SD, the general ARM module
runtime, physical video capture, and optional Zorro III Fast RAM are outside
this device model. Configure ordinary Amiberry Fast RAM separately.
