...
- Intel macOS JIT builds need non-PIE `__TEXT` fixed at 4GB plus a small `__PAGEZERO`; this keeps globals near low 32-bit JIT buffers while making fallback space allocatable.
